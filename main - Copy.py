...
host="localhost", user="root", password="password", database="restaurent")
...
def Promote_Employee():
        ...
        if(check_employee(Id) == False):
                ...
                # with given Id
                sql = 'select salary from employee1 where id=%s'
                data = (Id,)
                c = con.cursor()
                ...
                # given Id
                sql = 'update employee1 set salary=%s where id=%s'
                d = (t, Id)
...
def check_employee(employee_id):
        ...
        # rom employee Table
        sql = 'select * from employee1 where id=%s'
